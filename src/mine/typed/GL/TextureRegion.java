...
public class TextureRegion
{
	...
	public boolean equals(Object obj)
	{
		...
		if( Float.floatToIntBits(u1) != Float.floatToIntBits(other.u1) ) return false;
		if( Float.floatToIntBits(u2) != Float.floatToIntBits(other.u2) ) return false;
		if( Float.floatToIntBits(v1) != Float.floatToIntBits(other.v1) ) return false;
		if( Float.floatToIntBits(v2) != Float.floatToIntBits(other.v2) ) return false;
		return true;
	}
	...
	/**
	 * texture 에서 x , y 를 사각형 좌측 상단 모서리로 정하고 width 와 height 값 만큼 우측과 하단 방향으로
	 * 사각형을 정의 합니다.
	 * 
	 * @param texture
	 * @param x
