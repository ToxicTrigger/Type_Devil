...
public class LookAtCamera {
	...
	public LookAtCamera( final float fieldOfView, final float aspectRatio, final float near,
			final float far ) {
	...
	public void setMatrices(final GL10 gl) {
		...
		gl.glLoadIdentity( );
		GLU.gluLookAt( gl , this.position.x , this.position.y , this.position.z , this.lookAt.x ,
				this.lookAt.y , this.lookAt.z , this.up.x , this.up.y , this.up.z );
	}
}
