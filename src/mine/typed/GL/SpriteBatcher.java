...
/**
 * 객체를 화면에 배치해주는 클래스입니다.
 * <p>
 * 한 객체를 그리고 다른 객체를 그리는 형식이 아닌, 한개의 폴리곤에 그릴 것들을 몰아서 그립니다.
 * <p>
...
public class SpriteBatcher
{
	...
	/**
	 * 텍스쳐를 바인딩하고 SpriteBatcher 를 초기화하여 draw 를 준비합니다.
	 * <p>
	 * 주의 해야 하는 것은 두가지 입니다.
	 * <p>
	 * 1. beginBatch() 와 endBatch() 메서드 사이에 새로운 beginBatch() 메서드를 호출하지 마세요.
	 * <p>
	 * 2. beginBatch() 를 호출 하셧다면 반드시 endBatch() 를 호출 하셔야 합니다. 자세한 설명은 endBatch()
	 * doc 을 참고해 주세요.
	 *
	 * @param texture
	 */
	...
	/**
	 * 반드시 beginBatch() 가 호출된 후에 호출해 주세요.
	 * <p>
	 ...
	 * @param region
	 */
	public void drawSprite(final float x, final float y, final float width, final float height, final TextureRegion region)
	{
	...
	public void drawSprite(V2 pos, final float width, final float height, final TextureRegion region)
	{
	 ...
	 * @param region
	 */
	public void drawSprite(final float x, final float y, final float width, final float height, final float angle, final TextureRegion region)
	{
	...
	public void drawSprite(V2 pos, final float width, final float height, final float angle, final TextureRegion region)
	{
