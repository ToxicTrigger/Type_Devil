...
public class Vertices3 {
    ...
    public Vertices3(final GLGraphics glGraphics, final int maxVertices,
	    final int maxIndices, final boolean hasColor,
	    final boolean hasTexCoords, final boolean hasNormals) {
    ...
    public void setVertices(final float[] vertices, final int offset,
	    final int length) {
    ...
    public void setIndices(final short[] indices, final int offset,
	    final int length) {
    ...
    public void draw(final int primitiveType, final int offset,
