...
public class TypeDraw {
    ...
    public void makeRect(final float L, final float T, final float R,
	    final float B) {
    ...
    public void drawTexture(final SpriteBatcher sb, final float x,
	    final float y, final float angle) {
     ...
     */
    public void drawTexture(final SpriteBatcher sb, final float x,
	    final float y, final float w, final float h, final float angle,
	    final float A, final float R, final float G, final float B,
	    final GL10 gl) {
    ...
    public void drawTextureRegion(final Texture T, final float x,
	    final float y, final float w, final float h, final float a,
	    final float r, final float g, final float b, final float angle,
	    final GL10 gl, final TextureRegion Tr, final boolean draw) {
	if (draw) {
	    gl.glColor4f(r, g, b, a);
