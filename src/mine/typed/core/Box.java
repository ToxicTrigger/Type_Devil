...
public class Box
{
	...
	public int hashCode()
	{
		...
		final int prime = 31;
		int result = 1;
		result = (prime * result) + ((this.LeftEdgeUp == null) ? 0 : this.LeftEdgeUp.hashCode());
		result = (prime * result) + ((this.ReightEdgeDown == null) ? 0 : this.ReightEdgeDown.hashCode());
	...
	public boolean equals(Object obj)
	{
		...
		{
			if( other.LeftEdgeUp != null ) return false;
		} else if( !this.LeftEdgeUp.equals(other.LeftEdgeUp) ) return false;
		if( this.ReightEdgeDown == null )
		{
			if( other.ReightEdgeDown != null ) return false;
		} else if( !this.ReightEdgeDown.equals(other.ReightEdgeDown) ) return false;
		if( this.center == null )
		{
