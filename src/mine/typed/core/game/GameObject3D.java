...
public class GameObject3D {
     ...
     *            충돌체크
     */
    public GameObject3D(final float x, final float y, final float z,
	    final float radius) {
     ...
     */
    public GameObject3D(final float x, final float y, final float z,
	    final float cbW, final float cbH) {
	...
	return "GameObject3D [position=" + position + ", bounds=" + bounds + ", mcb=" + mcb + ", id=" + id + "]";
    }
