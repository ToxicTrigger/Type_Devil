...
public class Rectangle extends Diagram
{
	...
	public int hashCode()
	{
		...
		result = (prime * result) + ((this.lowerLeft == null) ? 0 : this.lowerLeft.hashCode());
	...
	public boolean equals(Object obj)
	{
		...
		{
			if( other.lowerLeft != null ) return false;
		} else if( !this.lowerLeft.equals(other.lowerLeft) ) return false;
