...
public class V2 {
    ...
    public static float quadrantRadian(final float x, final float y,
	    final float angle) {
    ...
    public float getNormalLine(final float sx, final float sy, final float ex,
	    final float ey, final float angle) {
