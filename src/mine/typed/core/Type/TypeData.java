...
/**
 * 변수들을 관리하기 편하게 하는 클래스.
 * 버퍼에 보호하고자 하는 변수를 담아두는 원리.
 * 값들을 복호화 암호화 하여 저장할수 있음.
 * @author mrminer
 * 
 */
public class TypeData {
	...
	public void getMemory( ) {
		...
		Log.i( "<PTData>" ,
				"NativeHeapFreeSize is " + Debug.getNativeHeapFreeSize( ) );
	}
	...
	public boolean equals(Object obj) {
		...
		if ( this.BackUpbyte != other.BackUpbyte )
			return false;
		if ( Double.doubleToLongBits( this.BackUpdouble ) != Double.doubleToLongBits( other.BackUpdouble ) )
			return false;
		if ( Float.floatToIntBits( this.BackUpfloat ) != Float.floatToIntBits( other.BackUpfloat ) )
			return false;
