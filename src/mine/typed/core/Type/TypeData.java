...
public class TypeData {
	...
	Log.i("<PTData>", "NativeHeapFreeSize is " + Debug
	...
	result = (prime * result) + ((this.BackUpobj == null) ? 0 : this.BackUpobj
		.hashCode());
	result = (prime * result) + this.BackUpshort;
	result = (prime * result) + ((this.BackUpstr == null) ? 0 : this.BackUpstr
		.hashCode());
	...
	if (this.BackUpboolean != other.BackUpboolean)
	    return false;
	if (this.BackUpbyte != other.BackUpbyte)
	    return false;
	if (Double.doubleToLongBits(this.BackUpdouble) != Double
		.doubleToLongBits(other.BackUpdouble))
	    return false;
	if (Float.floatToIntBits(this.BackUpfloat) != Float
		.floatToIntBits(other.BackUpfloat))
	    return false;
	if (this.BackUpint != other.BackUpint)
	    return false;
	if (this.BackUplong != other.BackUplong)
	    return false;
	if (this.BackUpobj == null) {
	    if (other.BackUpobj != null)
		return false;
	} else if (!this.BackUpobj.equals(other.BackUpobj))
	    return false;
	if (this.BackUpshort != other.BackUpshort)
	    return false;
	if (this.BackUpstr == null) {
	    if (other.BackUpstr != null)
		return false;
	} else if (!this.BackUpstr.equals(other.BackUpstr))
	    return false;
	if (this.framesCount != other.framesCount)
	    return false;
	if (this.framesCountAvg != other.framesCountAvg)
	    return false;
	if (this.framesTimer != other.framesTimer)
	    return false;
