...
public class TypeGraphic implements Graphic
{
	...
	public void drawPixmap(final Pixmap pixmap, final int x, final int y, final int srcX, final int srcY, final int srcW, final int srcH, final int alpha)
	{
		this.srcR.left = srcX;
		this.srcR.top = srcY;
	...
	public void drawPixmap(final Pixmap pixmap, final int x, final int y, final int alpha)
	{
		this.p.setAlpha(alpha);
	...
	@Override
	public void drawPixmap(final Pixmap pixmap, final int x, final int y, final int srcX, final int srcY, final int srcW, final int srcH)
	{
		this.srcR.left = srcX;
		this.srcR.top = srcY;
		this.srcR.right = (srcX + srcW) - 1;
