...
public class KeyMaker
{
	...
	/**
	 * 보안을 위해 직접 return 하지 않는다. 값은 ore 변수에 저장됩니다. 1 순위 호출 대상입니다.
	 */
	public void genOre()
	{
	...
	/**
	 * 보안 키들의 값을 검사하여 keyhole 의 값을 복구 합니다. 3 순위 호출 대상 입니다.
	 */
	public void Match()
	{
	...
	public boolean equals(Object obj)
	{
		...
		if( !(obj instanceof KeyMaker) ) return false;
		final KeyMaker other = (KeyMaker) obj;
		if( Double.doubleToLongBits(this.keyhole) != Double.doubleToLongBits(other.keyhole) ) return false;
		if( Double.doubleToLongBits(this.mould01) != Double.doubleToLongBits(other.mould01) ) return false;
		if( Double.doubleToLongBits(this.mould02) != Double.doubleToLongBits(other.mould02) ) return false;
		if( Double.doubleToLongBits(this.ore) != Double.doubleToLongBits(other.ore) ) return false;
		if( this.td == null )
		{
			if( other.td != null ) return false;
		} else if( !this.td.equals(other.td) ) return false;
		return true;
	}
