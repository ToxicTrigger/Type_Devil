...
public class KeyMaker {
	...
	if (Double.doubleToLongBits(this.keyhole) != Double
		.doubleToLongBits(other.keyhole))
	    return false;
	if (Double.doubleToLongBits(this.mould01) != Double
		.doubleToLongBits(other.mould01))
	    return false;
	if (Double.doubleToLongBits(this.mould02) != Double
		.doubleToLongBits(other.mould02))
	    return false;
	if (Double.doubleToLongBits(this.ore) != Double
		.doubleToLongBits(other.ore))
	    return false;
	if (this.td == null) {
	    if (other.td != null)
		return false;
